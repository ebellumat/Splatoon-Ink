...
<!-- The example row's hash is the real digest of its own four fields against
     https://github.com/mixandjam/Splatoon-Ink, so it does not match this repository's URL - it is an
...
npx proof-of-usage hash \
  ...
  --repo "https://github.com/mixandjam/Splatoon-Ink"
```

```bash
printf '%s' "ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/mixandjam/Splatoon-Ink" | shasum -a 256
```

```python
import hashlib
hashlib.sha256("ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/mixandjam/Splatoon-Ink".encode()).hexdigest()
```
